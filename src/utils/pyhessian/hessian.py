...
from src.utils.pyhessian.utils import group_product, group_add, normalization, get_params_grad, hessian_vector_product, orthnormal
...
class hessian():
    ...
    def __init__(self, model, criterion, data=None, dataloader=None, cuda=True):
        ...
        if not self.full_dataset:
            ...
            self.gradsH = grad(loss, self.inputs, create_graph=True, allow_unused=True)
    ...
    def eigenvalues(self, maxIter=100, tol=1e-3, top_n=1):
        ...
        while computed_dim < top_n:
            ...
            for i in range(maxIter):
                ...
                if computed_dim==top_n-1 and (b or i==maxIter-1):
                    retain = False
                
                if self.full_dataset:
                    tmp_eigenvalue, Hv = self.dataloader_hv_product(v)
                else:
                    Hv = hessian_vector_product(self.gradsH, self.params, v, retain)
